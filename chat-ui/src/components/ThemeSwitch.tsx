 ...
 * somebody changes twice and then forgets.
 */
export function ThemeSwitch({
  ...
  const SIGN_OUT = t('sign_out', lang, 'Sign out')

  const options: Array<{ value: ThemeChoice; icon: typeof Sun; label: string }> = [
    { value: 'system', icon: Monitor, label: t('theme_system', lang, 'Match the computer') },
    { value: 'light', icon: Sun, label: t('theme_light', lang, 'Light') },
    { value: 'dark', icon: Moon, label: t('theme_dark', lang, 'Night') },
  ]
  ...
  return (
    <div
      ...
      aria-label={t('theme', lang, 'Appearance')}
    >
